const Template5 = ({ data }) => {
  return (
    <div
      className="mx-auto bg-white rounded-lg shadow-md border border-slate-100 print:shadow-none"
      style={{ width: "210mm", minHeight: "297mm" }}
    >
      <div style={{ padding: "16mm" }}>
        {/* Top: Company + Meta */}
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-6 break-inside-avoid">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 break-inside-avoid">
          <div>
            {(data.accountName ||
              ...
              <div className="p-4 rounded-md border border-slate-100 bg-slate-50 break-inside-avoid">
                <div className="text-sm font-semibold text-slate-800 mb-2">
          ...
          <div>
            {data.notes && (
              <div className="p-4 rounded-md border border-slate-100 bg-white break-inside-avoid">
                <div className="text-sm font-semibold text-slate-800 mb-2">
                  Remarks
                </div>
