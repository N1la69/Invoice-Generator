const Template4 = ({ data }) => {
  return (
    <div className="mx-auto my-6 w-full max-w-5xl bg-white rounded-lg shadow-md border border-slate-100 overflow-hidden">
      <div className="md:flex md:items-stretch">
        {/* SIDEBAR */}
        <aside className="md:w-80 bg-indigo-50 p-6 shrink-0">
          <div className="flex flex-col items-start gap-4">
            ...
            <div className="mt-6 bg-white border border-indigo-100 rounded-md p-3 w-full hidden md:block">
